...
{
    public class PodmanVolumeRmFixture : ToolFixture<PodmanVolumeRmOptions>, ICakeContext
    {
        public PodmanVolumeRmFixture() : base("podman"){}
        ...
        {
            this.PodmanVolumeRm(Settings, Volume!);
        }
    }
}