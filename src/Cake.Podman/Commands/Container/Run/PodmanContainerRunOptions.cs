...
namespace Cake.Podman.Commands.Container.Run
{
    /// <summary>
    /// Options for Podman Container Run command
    /// </summary>
    public class PodmanContainerRunOptions : PodmanOptions
    {
        /// <summary>
        ...
        /// </summary>
        [PodmanOption(Name = "chrootdirs", Quoted = true, Format = FormatType.CommaSeparatedValue)]
        ...
        /// By default, containers run with the full CPU resource.
        /// </summary>
        ...
        /// Directory path, local or events_logger (local use container state file) (Default: local)
        /// </summary>
        [PodmanOption(Name = "health-log-destination", Quoted = true)]
        public string? HealthLogDestination { get; set; }
        /// <summary>
        /// Set maximum length in characters of stored HealthCheck log. 
        /// (“0” value means an infinite log length) (Default: 500 characters)
        /// </summary>
        [PodmanOption(Name = "health-max-log-size")]
        ...
        /// </summary>
        [PodmanOption(Name = "preserve-fd", Format = FormatType.CommaSeparatedValue)]
